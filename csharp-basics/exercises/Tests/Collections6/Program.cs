...
namespace FlightPlanner
{
    public class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var citiesAndDestinations = CreateCityAndDestinationDictionary(readText);
            var cities = CreateCityListFromDictionary(citiesAndDestinations);
        ...
        public static Dictionary<string, string> CreateCityAndDestinationDictionary(string[] text)
        {
            ...
            return citiesAndDestinations;
        }

        public static List<string> CreateCityListFromDictionary(Dictionary<string, string> citiesAndDestinations)
        {
